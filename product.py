...
class Cart(Resource):
    ...
    def get(self, product_id):
        # Checking whether the product id exists
    ...
    def put(self, product_id):
        ...
        # return a JSON object, along with the return code 201 after updating
...
# Adding resources for routing for class CartList
api.add_resource(CartList, '/product')
# Adding resources for routing for class Cart
...
# Documentação: https://sachinjose31.medium.com/create-and-deploy-a-flask-api-in-heroku-part-1-9ae99d185708
